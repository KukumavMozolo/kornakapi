 ...
 * {@link org.apache.mahout.clustering.lda.cvb.InMemoryCollapsedVariationalBayes0}.  If you want to do training directly in java code
 * with your own main(), then look to {@link org.apache.mahout.clustering.lda.cvb.ModelTrainer} and {@link org.apache.mahout.clustering.lda.cvb.TopicModel}.
 *
    ...
    public int run(Configuration conf,
        ...
        while (iterationNumber < maxIterations) {
            ...
            if (testFraction > 0 && iterationNumber % iterationBlockSize == 0) {
                ...
                log.info("(p_{} - p_{}) / p_0 = {}; target = {}", new Object[] {iterationNumber, iterationNumber - iterationBlockSize,
